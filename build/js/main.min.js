...
/* harmony import */ var _modules_ymap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/ymap */ "./js/modules/ymap.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var inputEmail = document.querySelector('[data-email-input]');
  ...
  // map
  var mapImage = document.querySelector('[data-img-map]');
  var mapYandex = document.querySelector('[data-map]');
  mapYandex.classList.remove('visually-hidden');
  mapImage.classList.add('visually-hidden');

  // яндекс-карта
  Object(_modules_ymap__WEBPACK_IMPORTED_MODULE_2__["map"])();
});
